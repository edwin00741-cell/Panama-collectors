  ...
  return (
    ...
    >
      ...
      <section className="article-image-grid">
        <img loading="lazy" decoding="async" src="/assets/images/generated/informes-ejecutivos-bancarios.webp" alt="Informes ejecutivos de gestión bancaria" />
        ...
        <img loading="lazy" decoding="async" src="/assets/images/generated/investigacion-operativa-activos.webp" alt="Planeación operativa y seguridad" />
      </section>
    </ContentPage>
  );
}
