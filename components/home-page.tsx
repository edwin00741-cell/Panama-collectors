...
export function HomePage({ locale = "es" }: { locale?: Locale }) {
  ...
  const featuredLabels = isEn
    ...
    : ["RecuperaciÃ³n de activos", "GestiÃ³n de cartera", "InvestigaciÃ³n operativa", "Informes ejecutivos"];
    ...
    <main>
      ...
      >
        ...
        <div className="hero-copy reveal">
          ...
          <h1><span>{isEn ? "Asset recovery and management for financial institutions." : "RecuperaciÃ³n y gestiÃ³n de activos para entidades financieras."}</span></h1>
          <p>{isEn ? "Operational partner for banks and financial companies in vehicle recovery, field investigation, portfolio updates, executive reporting and preventive custody." : "Aliado operativo para bancos y financieras en recuperaciÃ³n de autos, investigaciÃ³n de campo, actualizaciÃ³n de cartera, informes ejecutivos y custodia preventiva."}</p>
      ...
      <section className="section about-reference reveal">
        <div className="about-collage">
          ...
          <img loading="lazy" decoding="async" src="/assets/images/generated/cumplimiento-documental-bancario.webp" alt="GestiÃ³n documental" />
        </div>
        <div>
          <p className="eyebrow">{isEn ? "About the company" : "Sobre la empresa"}</p>
          <h2>{isEn ? "Company history of Panama Collectors S.A." : "ReseÃ±a histÃ³rica de Panama Collectors S.A."}</h2>
          <p>{isEn ? "Panamanian company specialized in collections management, recovery and adjudication of bank-owned movable assets, serving financial institutions." : "Empresa panameÃ±a especializada en gestiÃ³n de cobros, recuperaciÃ³n y adjudicaciÃ³n de bienes muebles bancarios, con operaciÃ³n orientada a entidades financieras."}</p>
          <div className="about-metric"><strong>2009</strong><span>{isEn ? "operations began with vehicle recovery and delinquent portfolios." : "inicio de operaciones con recuperaciÃ³n de autos y carteras morosas."}</span></div>
          <div className="about-metric"><strong>2022</strong><span>{isEn ? "legal formalization as Panama Collectors S.A." : "formalizaciÃ³n jurÃ­dica como Panama Collectors S.A."}</span></div>
          <a className="btn btn-secondary about-read-more" href={isEn ? "/en/company" : "/empresa"}>{isEn ? "Read full profile" : "Leer reseÃ±a completa"}</a>
        </div>
      </section>

      <section className="dark-planning section reveal">
        <div>
          <p className="eyebrow">{isEn ? "Operational solution" : "SoluciÃ³n operacional"}</p>
          <h2>{isEn ? "Planning, evidence and follow-up for every recovery." : "PlaneaciÃ³n, evidencia y seguimiento para cada recuperaciÃ³n."}</h2>
      ...
      <section className="trust-strip reveal" aria-label="Indicadores operativos">
        <div><strong>14+</strong><span>{isEn ? "years of experience" : "aÃ±os de experiencia"}</span></div>
        <div><strong>PanamÃ¡</strong><span>{isEn ? "capital city, interior and borders" : "capital, interior y fronteras"}</span></div>
        <div><strong>ISO 27001</strong><span>{isEn ? "certification process underway" : "en proceso de certificaciÃ³n"}</span></div>
        <div><strong>{isEn ? "Banks" : "Bancos"}</strong><span>{isEn ? "operation for financial institutions" : "operaciÃ³n para entidades financieras"}</span></div>
      </section>

      <section className="section services-section" id="servicios">
        <div className="section-heading reveal">
          <p className="eyebrow">{isEn ? "Operation for financial institutions" : "OperaciÃ³n para entidades financieras"}</p>
          ...
          <p>{isEn ? "Each service line is designed to operate with traceability, clear timing and documented communication." : "Cada lÃ­nea de servicio estÃ¡ pensada para operar con trazabilidad, tiempos claros y comunicaciÃ³n documentada."}</p>
        </div>
      ...
      <section className="section process-line reveal">
        <div className="section-heading"><p className="eyebrow">{isEn ? "Work process" : "Proceso de trabajo"}</p><h2>{isEn ? "From assignment to documented closure." : "De la asignaciÃ³n al cierre documentado."}</h2></div>
        <div className="process-steps">
          {(isEn ? ["Assignment", "Investigation", "Operation", "Report"] : ["AsignaciÃ³n", "InvestigaciÃ³n", "OperaciÃ³n", "Reporte"]).map((step, index) => (
            <article className="process-step" key={step}><strong>{String(index + 1).padStart(2, "0")}</strong><h3>{step}</h3><p>{(isEn ? ["We receive the portfolio, rules and priorities.", "We validate data and management routes.", "We activate field work, contact or procedures.", "We deliver updates, evidence and closure."] : ["Recibimos cartera, reglas y prioridades.", "Validamos datos y rutas de gestiÃ³n.", "Activamos campo, contacto o trÃ¡mite.", "Entregamos avances, evidencias y cierre."])[index]}</p></article>
          ))}
        </div>
      </section>

      <section className="image-strip reveal" aria-label="Casos operativos">
        <img loading="lazy" decoding="async" src="/assets/images/generated/actualizacion-cartera-bancaria.webp" alt="AsignaciÃ³n de casos" />
        <img loading="lazy" decoding="async" src="/assets/images/generated/investigacion-operativa-activos.webp" alt="InvestigaciÃ³n de casos" />
        <div className="strip-feature"><img loading="lazy" decoding="async" src="/assets/images/generated/tramites-vehiculares-bancarios.webp" alt="OperaciÃ³n de campo" /><span className="strip-label">Estrategia operativa <b className="icon-arrow-up-right" aria-hidden="true" /></span></div>
      ...
      <section className="section accordion-section reveal">
        <div className="accordion-copy">
          <p className="eyebrow">{isEn ? "Integrated operation" : "OperaciÃ³n integrada"}</p>
          <h2>{isEn ? "A coordinated operation for field work, data and reporting." : "Una operaciÃ³n coordinada para campo, datos y reportes."}</h2>
          <p>{isEn ? "We organize each case with investigation, operational management and progress evidence to support decision-making." : "Organizamos cada caso con investigaciÃ³n, gestiÃ³n operativa y evidencia de avance para facilitar la toma de decisiones."}</p>
        ...
        <div className="image-accordion" data-accordion>
          {[
            [isEn ? "Recovery" : "RecuperaciÃ³n", "/assets/images/generated/recuperacion-autos-bienes-bancarios.webp"],
            [isEn ? "Portfolio" : "Cartera", "/assets/images/generated/actualizacion-cartera-bancaria.webp"],
            [isEn ? "Investigation" : "InvestigaciÃ³n", "/assets/images/generated/investigacion-operativa-activos.webp"],
            [isEn ? "Reports" : "Informes", "/assets/images/generated/informes-ejecutivos-bancarios.webp"],
            [isEn ? "Integrated management" : "GestiÃ³n integral", "/assets/images/generated/panama-collectors-equipo-corporativo.webp"],
      ...
      <section className="section banks-section reveal" id="bancos">
        <div className="banks-showcase">
          <div className="banks-copy">
            ...
            <p>{isEn ? "Panama Collectors has collaborated with recognized financial institutions, providing recovery management, follow-up and operational support." : "Panama Collectors ha colaborado con entidades reconocidas del mercado financiero, aportando gestiÃ³n de recuperaciÃ³n, seguimiento y soporte operativo."}</p>
            ...
            <div className="banks-highlights"><span>{isEn ? "Asset recovery" : "RecuperaciÃ³n de activos"}</span><span>{isEn ? "Portfolio management" : "GestiÃ³n de cartera"}</span><span>{isEn ? "Executive reports" : "Reportes ejecutivos"}</span></div>
          </div>
      ...
      <section className="section proof-section reveal">
        <div className="section-heading"><p className="eyebrow">{isEn ? "Operational applications" : "Aplicaciones operativas"}</p><h2>{isEn ? "Visible confidence across every management front." : "Confianza visible en cada frente de gestiÃ³n."}</h2><p>{isEn ? "Field work, documentation, follow-up and reporting under a corporate operating standard." : "Campo, documentaciÃ³n, seguimiento y reportes bajo una lectura corporativa."}</p></div>
        <div className="proof-grid">
          {[
            [isEn ? "Field operation" : "Campo operativo", "/assets/images/generated/tramites-vehiculares-bancarios.webp", isEn ? "Asset recovery and management with traceability for banking institutions." : "RecuperaciÃ³n y gestiÃ³n de activos con trazabilidad para entidades bancarias."],
            [isEn ? "Document control" : "Control documental", "/assets/images/generated/cumplimiento-documental-bancario.webp", isEn ? "Organized information for decisions, follow-up and case closure." : "InformaciÃ³n organizada para tomar decisiones, dar seguimiento y cerrar casos."],
            [isEn ? "Integrated management" : "GestiÃ³n integral", "/assets/images/generated/centro-llamadas-cartera.webp", isEn ? "A coordinated team for portfolios, reports and client management." : "Un equipo coordinado para atender carteras, reportes y gestiÃ³n de clientes."],
      ...
      <section className="section location-section reveal" id="ubicacion">
        <div className="location-copy">
          <p className="eyebrow">{isEn ? "Location" : "UbicaciÃ³n"}</p>
          <h2>{isEn ? "Office in Obarrio, Panama City." : "Oficina en Obarrio, Ciudad de PanamÃ¡."}</h2>
          <p>{isEn ? "Panama Collectors operates from the PDC Building on Calle 56 D Este, a central location for coordination with financial institutions and operating teams." : "Panama Collectors atiende desde el Edificio PDC, en Calle 56 D Este, una zona cÃ©ntrica para coordinaciÃ³n con entidades financieras y equipos operativos."}</p>
          ...
          <div className="location-details">
            <span>{address}</span><span>{isEn ? "Panama, Republic of Panama" : "PanamÃ¡, RepÃºblica de PanamÃ¡"}</span>
      ...
      <section className="contact-section reveal" id="contacto">
        <div className="contact-copy">
          <p className="eyebrow">{isEn ? "Contact" : "Contacto"}</p><h2>{isEn ? "Let us coordinate an operational meeting." : "Coordinemos una reuniÃ³n operativa."}</h2>
          <p>{isEn ? "If your institution needs support in recovery, collections, portfolio management or asset adjudication, Panama Collectors can prepare a proposal according to the required scope." : "Si su entidad necesita apoyo en recuperaciÃ³n, cobros, cartera o adjudicaciÃ³n de bienes, Panama Collectors puede preparar una propuesta segÃºn el alcance requerido."}</p>
        ...
        <form className="contact-form" data-contact-form>
          ...
          <label>{isEn ? "Service of interest" : "Servicio de interÃ©s"}<select name="service"><option>{isEn ? "Asset and vehicle recovery" : "RecuperaciÃ³n de autos y bienes"}</option><option>{isEn ? "Portfolio update" : "ActualizaciÃ³n de cartera"}</option><option>{isEn ? "Operational investigation" : "InvestigaciÃ³n operativa"}</option><option>{isEn ? "Executive reports" : "Informes ejecutivos"}</option><option>{isEn ? "Integrated proposal" : "Propuesta integral"}</option></select></label>
          <label>{isEn ? "Message" : "Mensaje"}<textarea name="message" rows={4} placeholder={isEn ? "Briefly describe what you need" : "Cuente brevemente quÃ© necesita"} /></label>
