    ...
    <main>
      ...
      >
        ...
        <div className="hero-copy reveal">
          ...
          <div className="hero-actions">
            <a className="btn btn-primary has-whatsapp" href={whatsappUrl}><img src="/assets/whatsapp.png" alt="" /> {isEn ? "Contact on WhatsApp" : "Contactar por WhatsApp"}</a>
      ...
      <section className="contact-section reveal" id="contacto">
        <div className="contact-copy">
          ...
          <div className="contact-details"><a href={`mailto:${email}`}>{email}</a><a href={officePhoneUrl}>Oficina: {officePhone}</a><a className="has-whatsapp" href={whatsappUrl}><img src="/assets/whatsapp.png" alt="" /> WhatsApp: {whatsappPhone}</a><span>{address}</span></div>
        </div>
